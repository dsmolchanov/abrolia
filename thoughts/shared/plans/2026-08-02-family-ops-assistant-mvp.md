...
**Пауза для ручного подтверждения. После этой фазы реальные данные владельца-теста (не клиентов) допустимы — но только если к этому моменту закрыт юридический блокер ст. 9(2): переписка владельца содержит тех же третьих лиц и детей, что и переписка клиентов (уточнение ревизии Gate −1, см. `docs/privacy/lawful-bases.md`, р. 3).**
