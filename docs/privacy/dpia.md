...
6. Заполнены реквизиты контролёра (Axiom Atlas, LLC, Делавэр, США) и адрес для
   запросов субъектов (`support@abrolia.com`); notice содержит полный набор
   ст. 13/14. **Остаётся открытым:** представитель в Союзе по ст. 27 назначается
   письменно до первой реальной семьи, и только после этого в notice вносится
   надзорный орган государства-члена его учреждения.
