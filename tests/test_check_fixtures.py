...
GOOGLE_OAUTH_SAMPLE = joined("GOCSPX-", "abcdefghij", "KLMNOPQRST")
GOOGLE_REFRESH_SAMPLE = joined("1", "//", "0gabcdefghijklmnopqrstuvwxYZ012345")
WEBHOOK_SAMPLE = joined("0123456789abcdef" * 2, "fedcba9876543210" * 2)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (f"GOOGLE_CLIENT_SECRET={GOOGLE_OAUTH_SAMPLE}", "secret:google-oauth-secret"),
        (f"refresh_token={GOOGLE_REFRESH_SAMPLE}", "secret:google-refresh-token"),
        (f"NERVE_WEBHOOK_SECRET={WEBHOOK_SAMPLE}", "secret:webhook-secret"),
