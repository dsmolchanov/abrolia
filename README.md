...
- **Controller**: Axiom Atlas, LLC (Delaware, USA), registered office 131 Continental Dr, Suite 305, Newark, DE 19713. Data-subject requests: `support@abrolia.com`. No Art. 27 GDPR Union representative has been designated yet, which is one of the reasons real family data is not processed — see [`docs/privacy/privacy-notice-en.md`](docs/privacy/privacy-notice-en.md).
